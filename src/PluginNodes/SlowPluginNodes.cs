namespace OpcPlc.PluginNodes
{
    ...
    public class SlowPluginNodes : IPluginNodes
    {
        ...
        {
            (_nodes, _badNodes, _numberOfUpdates) = CreateNodes(NodeType, "Slow", NodeCount, folder, simulatorFolder, NodeRandomization, NodeStepSize, NodeMinValue, NodeMaxValue);
        ...
        public void UpdateNodes(object state, ElapsedEventArgs elapsedEventArgs)
        {
